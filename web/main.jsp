...
<%    String nombres = (String) session.getAttribute("nombre") + " " + (String) session.getAttribute("appaterno");
    ...
    String MENU_EMPRESA = "<ul class='navbar-nav mr-auto'><li onclick='cambiar(this, \"panel-empresa\");' class='nav-item'><a class='nav-link' href='#'>Panel Empresa <span class='sr-only'>(current)</span></a></li><li onclick='cambiar(this, \"rutero\");' class='nav-item'><a class='nav-link' href='#'>Carga Rutero <span class='sr-only'>(current)</span></a></li></ul>";
    String MENU_EMPRESA_BETA = "<ul class='navbar-nav mr-auto'><li onclick='cambiar(this, \"panel-empresa\");' class='nav-item'><a class='nav-link' href='#'>Panel Empresa <span class='sr-only'>(current)</span></a></li><li onclick='cambiar(this, \"rutero-beta\");' class='nav-item'><a class='nav-link' href='#'>Carga Rutero <span class='sr-only'>(current)</span></a></li></ul>";
%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<script type="text/javascript">
    
    $(document).ready(function(){
        OPCIONES_DATATABLES.fixedHeader.headerOffset = $('#navbar').outerHeight();
    });
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            <nav id="navbar" class="navbar small navbar-expand-sm navbar-light bg-light fixed-top"><img src='img/logo.jpg' height="40" width='50' />
